...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/03/25 14:16:18 by azaliaus          #+#    #+#             */
/*   Updated: 2019/05/18 19:33:32 by azaliaus         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ssl.h"

char	*prepare_sha256_padded_message(char *msg, uint64_t len, uint64_t plen)
{
	char				*new;
